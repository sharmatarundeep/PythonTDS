...
for i in xrange(1,256):
	...
	child.expect("#")
	child.sendline("ip address 24.1."+str(i)+".1/24")
	child.expect("#")
        child.sendline("ipv6 address 24:1:"+hex(i)[2:]+"::1/64")
	child.expect("#")
child.sendline('exit')
child.expect("#")
...
for i in xrange(256,512):
	...
	child.sendline("encapsulation dot1q vlan  "+str(vlanid))
	child.expect("#")
	child.sendline("ip address 24.2."+str(i-256)+".1/24")
	child.expect("#")
        child.sendline("ipv6 address 24:1:"+hex(i)[2:]+"::1/64")
	child.expect("#")
child.sendline('exit')
...
for i in xrange(512,768):
	...
	child.sendline("encapsulation dot1q vlan  "+str(vlanid))
	child.expect("#")
	child.sendline("ip address 24.3."+str(i-512)+".1/24")
	child.expect("#")
        child.sendline("ipv6 address 24:1:"+hex(i)[2:]+"::1/64")
	child.expect("#")
child.sendline('exit')
...
for i in xrange(768,1023):
	...
	child.sendline("encapsulation dot1q vlan  "+str(vlanid))
	child.expect("#")
	child.sendline("ip address 24.4."+str(i-768)+".1/24")
	child.expect("#")
        child.sendline("ipv6 address 24:1:"+hex(i)[2:]+"::1/64")
	child.expect("#")
child.sendline('exit')
